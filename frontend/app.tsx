      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <main className="mt-6 space-y-6">
          ...
          <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 shadow-xl shadow-black/40">
            <div className="flex items-center justify-between mb-4 gap-2">
              ...
              <button
                type="button"
                onClick={addAccount}
                className="inline-flex items-center rounded-lg border border-slate-700 bg-slate-900 px-3 py-1.5 text-[0.7rem] font-medium text-slate-200 hover:border-sky-500 hover:text-sky-300"
              >
                + Hesap Ekle
              </button>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="örn: ali.veli@example.com"
                  />
                </div>
              </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          ...
                          className="text-[0.65rem] text-slate-500 hover:text-red-400 disabled:opacity-40"
                        >
                          Sil
                        </button>
                      </div>
                      ...
                      <div className="grid gap-2 md:grid-cols-3">
                        <div className="space-y-1">
                          ...
                          <select
                            className="w-full rounded-lg border border-slate-700 bg-slate-900/90 px-2 py-1.5 text-xs text-slate-100 outline-none focus:border-sky-500"
                            value={acc.platform}
                            onChange={(e) =>
                              handleAccountChange(
                                index,
                      ...
                      <div className="mt-2 space-y-2">
                        <label className="text-[0.7rem] text-slate-400 block">
                          Profil Bio / Açıklama (isteğe bağlı)
                        </label>
                        <textarea
                          className="w-full rounded-lg border border-slate-700 bg-slate-900/90 px-2 py-1.5 text-xs text-slate-100 outline-none focus:border-sky-500 min-h-[50px]"
                          value={acc.bio_text}
                          onChange={(e) =>
                            handleAccountChange(
                              index,
                          ...
                          placeholder="Örn: Usak · Veri & Analitik meraklısı"
                        />
                      </div>
              ...
              <div className="flex items-center justify-between pt-2">
                {error && (
                  <span className="text-xs text-red-400">Hata: {error}</span>
                )}
                <button
                  type="submit"
                  disabled={loading}
                  className="ml-auto inline-flex items-center rounded-lg bg-sky-500 px-4 py-2 text-xs font-medium text-white hover:bg-sky-400 disabled:opacity-60 disabled:cursor-not-allowed"
                >
          ...
          <section className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.6fr)]">
            {/* Skor */}
            <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-xl shadow-black/40 text-center">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 shadow-xl shadow-black/40">
              ...
              {loading ? (
                ...
                <p className="text-slate-500 text-xs">
                  Henüz risk listesi yok. Analiz sonrası burada detaylı maddeler
                  görünecek.
                </p>
              ) : (
                ...
                <div className="space-y-1">
                  ...
                  {data.email_exposure.keybase_found == null ? (
                    ...
                    <p className="text-slate-400">
                      ...
                      durumda kimlik doğrulama açısından güçlü bir bağ
                      oluşurken, izlenebilirlik açısından da görünürlüğün
                      artabileceğini unutmamakta fayda var.
                    </p>
                  ) : (
                    <p className="text-slate-400">
